...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['user_password', 'user_type', 'created_at', 'created_by', 'fio'], 'required'],
            [['created_at', 'updated_at', 'avatar', 'phone'], 'safe'],
            ...
            [['secret_key', 'session_id', 'username'], 'unique'],
        ];
    }
    ...
    {
        return static::findOne(['user_password' => md5($password)]);
    }
